...
export async function loadVocabulary() {
  ...
  const examples = (await readFile('lib/vocabulary-examples.ts', 'utf8'))
    .replace("import corpus from '@/data/corpus-v21-public.json';", '');
  ...
  const source = (await readFile('lib/vocabulary.ts', 'utf8'))
    ...
    .replace("import { publicExamplesForVocabulary } from '@/lib/vocabulary-examples';", examples)
