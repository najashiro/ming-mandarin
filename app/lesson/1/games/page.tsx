...
export default async function GamesPage() {
  ...
  return <SiteShell><CommunityContextProvider context={{lessonId:1,section:'games',route:'/lesson/1/games'}}><main><LessonHeader eyebrow="游戏中心 · ARCADE" title="28 formas de practicar" description="Cada tarjeta abre un juego real usando el corpus auditado; no hay contenido de otras lecciones." /><div className="community-page-action shell"><CommunityButton label="Preguntar sobre los juegos"/></div><Arcade exercises={exercises} hanziCharacters={hanziCharacters} /></main></CommunityContextProvider></SiteShell>;
}
